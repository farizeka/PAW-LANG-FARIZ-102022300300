...
if ($search){
    ...
    if (strlen($search < 3)){
        ...
        $search = '';
    } elseif (preg_match($pattern, $search)){
...
$query = "SELECT * FROM tb_buku WHERE judul LIKE '% $judul%'";
...
<body>
    ...
    <div class="container mt-5">
        ...
        <form action="katalog_buku.php" class="form-inline" method='GET'>
            ...
            <input class="form-control mr-sm-2" type="search" name="search" placeholder="Search" aria-label="Search" value="<?php $search ?>">
